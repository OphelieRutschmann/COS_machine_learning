...
The main tasks performed during this project were:
- Loading the dataset and obtaining an overview of what it contains
- Performing basic exploratory data analysis (numerical summaries, visualization)
- Computing some simple probabilities on the dataset

The solutions are stored in the "communes_solution.ipynb" file